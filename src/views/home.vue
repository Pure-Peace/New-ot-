  ...
  <div>
    <div class="intro-container">
      <div class="intro-left">
        ...
        <div style="height: 80px; padding: 40px 0;">
          <span
      ...
      announcements: [
        {
          title: 'OCLC S4 开始报名啦',
          type: '比赛宣传',
          content: '近期将举办第六届OCLC，即日起接受玩家报名，报名截止时间为6月17日，比赛将在报名截止一周内正式开始。比赛形式为Team vs，4v4 BO9（9局5胜），使用 Score v1，fail 算分。选手以个人为单位报名，不接受组队报名。在报名流程结束后，根据参赛玩家实力选出若干名队长。各队长以选秀（draft）形式挑选队员并组队，以此避免出现宇宙队。',
          datetime: '2019年11月8日 20:18:59',
          cover: '',
          link: {
            href: '',
            title: '这是假的..'
